  ...
  return (
    <div className="flex-grow text-white h-screen overflow-y-auto scrollbar-hide">
      <header className="absolute top-4 right-8">
        ...
        {openModal && (
          <div className="absolute bottom-[-2.2rem] opacity-90 hover:opacity-80 cursor-pointer rounded-full bg-black py-1 w-[100%] flex items-center justify-center" onClick={() => signOut()}>
            <h1>Log Out</h1>
          </div>
        )}
      </header>

      <section className={`bg-gradient-to-b ${background} to-black h-96 pl-10`}>
        <div className="flex items-end flex-wrap space-x-7 pt-20">
